    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-logo { font-size: 22px; font-weight: 700; text-decoration: none; display: flex; align-items: baseline; gap: 0; }
      ...
      {/* NAV */}
      <nav className="nav">
        <a href="/" className="nav-logo"><span style={{fontWeight:700,fontSize:'22px',letterSpacing:'-0.5px'}}><span style={{color:'#202124'}}>Gu</span><span style={{color:'#1a73e8'}}>ia</span><span style={{color:'#202124'}}>mos</span></span><span style={{fontSize:'12px',fontWeight:400,color:'#5f6368',marginLeft:'8px'}}>by Anthropic Claude</span></a>
