    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-logo { font-size: 24px; font-weight: 700; color: #1a73e8; text-decoration: none; display: flex; align-items: baseline; gap: 8px; }
      ...
      {/* NAV */}
      <nav className="nav">
        <a href="/" className="nav-logo"><span style={{fontWeight:700,letterSpacing:'-0.5px',lineHeight:'1'}}><span style={{color:'#202124'}}>Gu</span><span style={{color:'#1a73e8'}}>ia</span><span style={{color:'#202124'}}>mos</span></span><span style={{fontSize:'11px',fontWeight:400,color:'#5f6368'}}>by Anthropic Claude</span></a>
